function [B,stats] = lassoglm_fix(x,y,distr,varargin)
...
if ~isequal(cvp,'resubstitution')
    ...
    cvfun = @(Xtrain,Ytrain,Xtest,Ytest) lassoFitAndPredict( ...
        Xtrain,Ytrain,Xtest,Ytest, ...  % hack the weights.
        lambda/totalWeight*size(Xtrain,1),alpha,P,standardize,reltol,maxIter,ever_active, ...
